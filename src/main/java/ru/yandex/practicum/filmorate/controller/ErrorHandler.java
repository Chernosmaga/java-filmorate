...
public class ErrorHandler {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse handleNoCommonFriendsException(final NoCommonFriendsException exception) {
        return new ErrorResponse(
                exception.getMessage()
        );
    }
    ...
    public ErrorResponse handleOtherException(final OtherException exception) {
        return new ErrorResponse(
                exception.getMessage()
        );
    }
